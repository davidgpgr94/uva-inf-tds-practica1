...
//		//Variables para las pruebas de los metodos
//		String emails[];
//		
//		//Añadir nueva persona (correcta)
//		emails = new String[] {"asdf@gmail.com"};
//		eContactImple.createNewPerson("Jose Luis", "Joselu", "", emails, null);
//		
